...
describe("INIT params", () => {
  ...
  test("type is x, then params overshoot is 1.0", () => {
    render(<EaseBackParams type="x" setIsValid={vi.fn()} />);
