...
vi.mock("./component/player/Cel.jsx", () => ({
  default: ({ id, setMsg }) => {
    return (
...
vi.mock("./component/configs/Pattern/PatternImage.jsx", () => ({
  default: () => {
  ...
  describe("Menu", () => {
    beforeEach(() => {
      window.appMenu = {
        ...
        onReceiveSave: vi.fn(),
        onReceiveLoad: vi.fn(),
        onReceiveLanguage: vi.fn(),
        onReceiveUndo: vi.fn(),
        onReceiveRedo: vi.fn(),
        onReceiveSaveAs: vi.fn(),
    ...
    test("call langage, then change lang", () => {
      window.initArgs = { lang: vi.fn().mockReturnValue("ja") };
      let changeLang;
